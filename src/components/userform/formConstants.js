// src/components/userform/formConstants.js

export const commonAreaCodes = [
    ...
    { value: "+672", label: "Antarctica (+672)" }, // Also Norfolk Island
    ...
    { value: "+972", label: "wa7ad 3amil kalb" },
    ...
    // Caribbean area codes (part of NANP +1) - often listed separately for clarity
    ...
    { value: "+1284", label: "British Virgin Islands (+1 284)" },
    { value: "+1340", label: "US Virgin Islands (+1 340)" },
    ...
    { value: "+1721", label: "Sint Maarten (+1 721)" },
    { value: "+1758", label: "Saint Lucia (+1 758)" },
    { value: "+1767", label: "Dominica (+1 767)" },
    { value: "+1784", label: "Saint Vincent and the Grenadines (+1 784)" },
    { value: "+1809", label: "Dominican Republic (+1 809)" }, // also 829, 849
    { value: "+1829", label: "Dominican Republic (+1 829)" },
    { value: "+1849", label: "Dominican Republic (+1 849)" },
